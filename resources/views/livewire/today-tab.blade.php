    ...
    <x-filament::section>
        <div class="grid col-span-2 grid-flow-col gap-4">
            <div class="col-span-1">
                @livewire(TodayTransactions::class,['total_transactions' => $data['total_transaction']])
            </div>
            <div class="col-span-1">
                @livewire(TodayGrossTotal::class,['total_sales' => $data['total_sales']])
            </div>
        </div><br>
        <div class="grid grid-flow-col grid-cols-5 gap-4">
            <div class="col-span-3">
                @livewire(TodaySales::class)
            </div>
            <div class="col-span-2">
                @livewire(TodayIncome::class,['chartData' => $data['income']])
            </div>
        </div><br>
        <div class="grid col-span-2 grid-flow-col gap-4">
            <div class="col-span-1">
