    ...
    <x-filament::section>
        <div class="grid col-span-2 grid-flow-col gap-4">
            <div class="col-span-1">
                @livewire(YearlyTransactions::class,['total_transactions' => $data['total_transaction']])
            </div>
            <div class="col-span-1">
                @livewire(YearlyGrossTotal::class,['total_sales' => $data['total_sales']])
            </div>
        </div><br>
        <div class="grid grid-flow-col grid-cols-5 gap-4">
            ...
            <div class="col-span-2">
                @livewire(YearlyIncome::class,['chartData' => $data['income']])
            </div>
        </div><br>
        <div class="grid col-span-2 grid-flow-col gap-4">
            <div class="col-span-1">
