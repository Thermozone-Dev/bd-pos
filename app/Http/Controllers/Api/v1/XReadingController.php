...
class XReadingController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        $_journal_x_reading = [
            ...
            '',
            ' Start Date & Time: ',
            str_pad($shift['start_time'], 20, ' ', STR_PAD_LEFT),
            '',
            ' End Date & Time: ',
            str_pad($shift['end_time'], 22, ' ', STR_PAD_LEFT),
            ' ',
    ...
    public function reprint(Request $request)
    {
        ...
        $_journal_x_reading = [
            ...
            ' ',
            ' Start Date & Time: ',
            str_pad($latestXRecord->start_time, 20, ' ', STR_PAD_LEFT),
            '',
            ' End Date & Time: ',
            str_pad($latestXRecord->end_time, 22, ' ', STR_PAD_LEFT),
            ' ',
